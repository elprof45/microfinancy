...
const sections = [
  { path: '/societes', title: 'Sociétés', description: 'Gérer les sociétés et leurs données générales.' },
  { path: '/agences', title: 'Agences', description: 'Gérer les agences et leur rattachement.' },
  { path: '/users', title: 'Utilisateurs', description: 'Gérer les utilisateurs, rôles et accès.' },
  { path: '/client-totines', title: 'Clients Totine', description: 'Gestion des clients Totine et de leurs fiches.' },
  { path: '/carnets', title: 'Carnets', description: 'Suivre les carnets de collecte et leurs clients.' },
  { path: '/cotisations', title: 'Cotisations', description: 'Créer et suivre les cotisations client.' },
  { path: '/comptes', title: 'Comptes', description: 'Consulter et modifier les comptes clients.' },
  { path: '/mouvement-epargnes', title: 'Mouvements épargne', description: 'Gérer les mouvements d’épargne et les références.' },
  { path: '/mouvement-items', title: 'Mouvements items', description: 'Suivre les dépôts et retraits sur les comptes.' },
  { path: '/client-soldes', title: 'Soldes clients', description: 'Consulter et ajuster les soldes totaux des clients.' },
  { path: '/mouvement-totines', title: 'Mouvements totines', description: 'Enregistrer les mouvements Totine et leurs montants.' },
]
    ...
    <div className="mx-auto max-w-7xl px-6 py-10">
      ...
      <section className="mt-8 grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
        ...
        <article className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <p className="mt-3 text-sm leading-6 text-slate-600">Chaque ressource est accessible par une page dynamique : <code className="rounded bg-slate-100 px-1.5 py-0.5 text-xs">/societes</code>, <code className="rounded bg-slate-100 px-1.5 py-0.5 text-xs">/agences</code>, <code className="rounded bg-slate-100 px-1.5 py-0.5 text-xs">/users</code>, etc.</p>
        </article>
        <article className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
